            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                profileImageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        databaseReference.child("Profiles").child(uuidStr).child("userimageurl").setValue(downloadURL);
                        databaseReference.child("Profiles").child(uuidStr).child("userage").setValue(userAge);
                        databaseReference.child("Profiles").child(uuidStr).child("useremail").setValue(userEmail);
